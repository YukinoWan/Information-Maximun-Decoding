...
def load_models(device="cuda"):
    ...
    frame_tokenizer.load_state_dict(torch.load("./output/adapter/mmau_frame_adapter_decoder_tokenizer_6.pt"))
...
def main():
    ...
    parser.add_argument("--output_path", type=str, default="evaluation_output/inference_decoder_adapter_subset_ckpt6_results.json")
