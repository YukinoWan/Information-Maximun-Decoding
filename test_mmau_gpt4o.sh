...
TEST_NAME="r1-aqa-caption-gpt4o"
OUT_DIR=evaluation/test_${TEST_NAME}


python3 src/test_mmau.py --model_path ${MODEL_DIR} --data_file evaluation/test_r1-aqa-caption-sub/res_mmau_mini.json --audio_dir ${MMAU_DIR} --out_file ${OUT_DIR}/res_mmau_mini.json --batch_size 1  --temperature 0.7 || exit 1
