...
TEST_NAME="r1-aqa-5-caption-with-question-gpt4o-cot"
OUT_DIR=evaluation/test_${TEST_NAME}


python3 src/test_mmau.py --model_path ${MODEL_DIR} --data_file caption/test_r1-aqa-5-caption-with-question/res_mmau_mini.json --audio_dir ${MMAU_DIR} --out_file ${OUT_DIR}/res_mmau_mini.json --batch_size 1  --mode "5-caption-evaluation-cot" --temperature 0.7 || exit 1
